                            ...
                            <div className=' w-full xl:w-[85%]'>
                                ...
                                <div className='bg-white hidden lg:block rounded-sm shadow-md h-auto mt-4'>
                                    ...
                                    <div className='flex flex-col w-full items-center justify-center'>
                                        ...
                                        <Link className='hover:bg-[#F5FAFF] hover:text-primary bg-[#f5faffdd] text-primary w-full text-center py-3 text-sm' to="/user/address">Manage address</Link>
                                ...
                                <div className=' lg:hidden rounded-sm h-auto mt-4 flex items-center justify-evenly'>
                                    ...
                                    <div className='flex flex-col gap-2'>
                                        ...
                                        <Link className='flex items-center justify-start gap-5 px-5 py-5 shadow-md rounded-md bg-light' to="/user/address">
                                            <i className='text-2xl text-base-200'><FaHome /></i>
                                            <p className='text-md font-semibold text-base-200'>ADDRESS</p>
                                        </Link>
                                    </div>
                                    <div className='flex flex-col gap-2'>
